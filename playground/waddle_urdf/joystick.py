...
from playground.waddle_urdf.custom_rewards import reward_imitation
    ...
    def _post_init(self) -> None:
        ...
        if USE_IMITATION_REWARD:
            self.PRM = PolyReferenceMotion(
                "playground/waddle_urdf/data/polynomial_coefficients_11degtrunk_inverted.pkl"
            )
